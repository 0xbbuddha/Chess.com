...
[**Aphrodite**](https://github.com/0xbbuddha/Aphrodite) — a Mythic Nim agent with native Chess.com transport (`-d:c2ProfileChesscom`), EKE staging, and full command support.
...
For authorized testing environments only. Using Chess.com's private API endpoints may violate their Terms of Service.
